...
+(void) createFeatures1WithGeoPackage: (GPKGGeoPackage *) geoPackage andSrs: (GPKGSpatialReferenceSystem *) srs{
    ...
    [points addObject:[SFPoint pointWithXValue:-104.801918 andYValue:39.720014]];
    [pointNames addObject:@"BIT Systems"];
    
    [points addObject:[SFPoint pointWithXValue:-104.802987 andYValue:39.717703]];
    [pointNames addObject:@"Community College of Aurora CentreTech Campus"];
    
    [points addObject:[SFPoint pointWithXValue:-104.807496 andYValue:39.714085]];
    [pointNames addObject:@"DeLaney Community Farm"];
    
    [points addObject:[SFPoint pointWithXValue:-104.799480 andYValue:39.714729]];
    ...
    SFLineString *line1 = [SFLineString lineString];
    [line1 addPoint:[SFPoint pointWithXValue:-104.800614 andYValue:39.720721]];
    [line1 addPoint:[SFPoint pointWithXValue:-104.802174 andYValue:39.720726]];
    [line1 addPoint:[SFPoint pointWithXValue:-104.802584 andYValue:39.720660]];
    [line1 addPoint:[SFPoint pointWithXValue:-104.803088 andYValue:39.720477]];
    [line1 addPoint:[SFPoint pointWithXValue:-104.803474 andYValue:39.720209]];
    
    [lines addObject:line1];
    [lineNames addObject:@"East Lockheed Drive"];
    
    SFLineString *line2 = [SFLineString lineString];
    [line2 addPoint:[SFPoint pointWithXValue:-104.809612 andYValue:39.718379]];
    [line2 addPoint:[SFPoint pointWithXValue:-104.806638 andYValue:39.718372]];
    [line2 addPoint:[SFPoint pointWithXValue:-104.806236 andYValue:39.718439]];
    [line2 addPoint:[SFPoint pointWithXValue:-104.805939 andYValue:39.718536]];
    [line2 addPoint:[SFPoint pointWithXValue:-104.805654 andYValue:39.718677]];
    [line2 addPoint:[SFPoint pointWithXValue:-104.803652 andYValue:39.720095]];
    
    [lines addObject:line2];
    [lineNames addObject:@"E 1st Ave"];
    
    SFLineString *line3 = [SFLineString lineString];
    [line3 addPoint:[SFPoint pointWithXValue:-104.806344 andYValue:39.722425]];
    [line3 addPoint:[SFPoint pointWithXValue:-104.805854 andYValue:39.722634]];
    [line3 addPoint:[SFPoint pointWithXValue:-104.805656 andYValue:39.722647]];
    [line3 addPoint:[SFPoint pointWithXValue:-104.803749 andYValue:39.722641]];
    [line3 addPoint:[SFPoint pointWithXValue:-104.803769 andYValue:39.721849]];
    [line3 addPoint:[SFPoint pointWithXValue:-104.803806 andYValue:39.721725]];
    [line3 addPoint:[SFPoint pointWithXValue:-104.804382 andYValue:39.720865]];
    ...
    SFPolygon *polygon1 = [SFPolygon polygon];
    SFLineString *ring1 = [SFLineString lineString];
    [ring1 addPoint:[SFPoint pointWithXValue:-104.802246 andYValue:39.720343]];
    [ring1 addPoint:[SFPoint pointWithXValue:-104.802246 andYValue:39.719753]];
    [ring1 addPoint:[SFPoint pointWithXValue:-104.802183 andYValue:39.719754]];
    [ring1 addPoint:[SFPoint pointWithXValue:-104.802184 andYValue:39.719719]];
    [ring1 addPoint:[SFPoint pointWithXValue:-104.802138 andYValue:39.719694]];
    [ring1 addPoint:[SFPoint pointWithXValue:-104.802097 andYValue:39.719691]];
    [ring1 addPoint:[SFPoint pointWithXValue:-104.802096 andYValue:39.719648]];
    [ring1 addPoint:[SFPoint pointWithXValue:-104.801646 andYValue:39.719648]];
    [ring1 addPoint:[SFPoint pointWithXValue:-104.801644 andYValue:39.719722]];
    [ring1 addPoint:[SFPoint pointWithXValue:-104.801550 andYValue:39.719723]];
    [ring1 addPoint:[SFPoint pointWithXValue:-104.801549 andYValue:39.720207]];
    [ring1 addPoint:[SFPoint pointWithXValue:-104.801648 andYValue:39.720207]];
    [ring1 addPoint:[SFPoint pointWithXValue:-104.801648 andYValue:39.720341]];
    [ring1 addPoint:[SFPoint pointWithXValue:-104.802246 andYValue:39.720343]];
    ...
    SFPolygon *polygon2 = [SFPolygon polygon];
    
    SFLineString *ring2 = [SFLineString lineString];
    [ring2 addPoint:[SFPoint pointWithXValue:-104.
];
    [ring1 addPoint:[SFPoint pointWithXValue:-77.195410 andYValue:38.754930]];
    [ring1 addPoint:[SFPoint pointWithXValue:-77.195350 andYValue:38.754884]];
    [ring1 addPoint:[SFPoint pointWithXValue:-77.195228 andYValue:38.754966]];
    [ring1 addPoint:[SFPoint pointWithXValue:-77.195135 andYValue:38.754889]];
    [ring1 addPoint:[SFPoint pointWithXValue:-77.195048 andYValue:38.754956]];
    [ring1 addPoint:[SFPoint pointWithXValue:-77.194986 andYValue:38.754906]];
    [ring1 addPoint:[SFPoint pointWithXValue:-77.194897 andYValue:38.754976]];
    [ring1 addPoint:[SFPoint pointWithXValue:-77.194953 andYValue:38.755025]];
    [ring1 addPoint:[SFPoint pointWithXValue:-77.194763 andYValue:38.755173]];
    [ring1 addPoint:[SFPoint pointWithXValue:-77.194827 andYValue:38.755224]];
    [ring1 addPoint:[SFPoint pointWithXValue:-77.195012 andYValue:38.755082]];
    [ring1 addPoint:[SFPoint pointWithXValue:-77.195041 andYValue:38.755104]];
    [ring1 addPoint:[SFPoint pointWithXValue:-77.195028 andYValue:38.755116]];
    [ring1 addPoint:[SFPoint pointWithXValue:-77.195090 andYValue:38.755167]];
    [ring1 addPoint:[SFPoint pointWithXValue:-77.195106 andYValue:38.755154]];
    [ring1 addPoint:[SFPoint pointWithXValue:-77.195205 andYValue:38.755233]];
    [ring1 addPoint:[SFPoint pointWithXValue:-77.195299 andYValue:38.755159]];
    [polygon1 addRing:ring1];
...
+(void) createNonLinearGeometryTypesExtensionWithGeoPackage: (GPKGGeoPackage *) geoPackage{
    ...
    SFCircularString *circularString = [SFCircularString circularString];
    [circularString addPoint:[SFPoint pointWithXValue:-122.358 andYValue:47.653]];
    [circularString addPoint:[SFPoint pointWithXValue:-122.348 andYValue:47.649]];
    [circularString addPoint:[SFPoint pointWithXValue:-122.348 andYValue:47.658]];
    [circularString addPoint:[SFPoint pointWithXValue:-122.358 andYValue:47.658]];
    [circularString addPoint:[SFPoint pointWithXValue:-122.358 andYValue:47.653]];
    ...
    for(int i = (int)SF_CIRCULARSTRING; i <= (int)SF_SURFACE; i++){
        ...
        switch (geometryType) {
            ...
            case SF_COMPOUNDCURVE:
                {
                    SFCompoundCurve *compoundCurve = [SFCompoundCurve compoundCurve];
            ...
            case SF_CURVEPOLYGON:
                {
                    SFCurvePolygon *curvePolygon = [SFCurvePolygon curvePolygon];
            ...
            case SF_MULTICURVE:
                {
                    SFMultiLineString *multiCurve = [SFMultiLineString multiLineString];
            ...
            case SF_MULTISURFACE:
                {
                    SFMultiPolygon *multiSurface = [SFMultiPolygon multiPolygon];
            ...
            case SF_CURVE:
                {
                    SFCompoundCurve *curve = [SFCompoundCurve compoundCurve];
            ...
            case SF_SURFACE:
                {
                    SFCurvePolygon *surface = [SFCurvePolygon curvePolygon];
...
+(void) insertRelatedTablesMediaExtensionRowsWithGeoPackage: (GPKGGeoPackage *) geoPackage andRelation: (GPKGExtendedRelation *) relation andQuery: (NSString *) query andName: (NSString *) name andFile: (NSString *) file andContentType: (NSString *) contentType andDescription: (NSString *) description andSource: (NSString *) source{
    ...
    [GPKGRelatedTablesUtils populateUserRowWithTable:[mediaDao mediaTable] andRow:mediaRow andSkipColumns:[GPKGMediaTable requiredColumns]];
...
+(void) createRelatedTablesSimpleAttributesExtensionWithGeoPackage: (GPKGGeoPackage *) geoPackage{
    ...
    for(int i = 1; i <=3; i++){
        ...
        [GPKGRelatedTablesUtils populateUserRowWithTable:[simpleAttributesRow simpleAttributesTable] andRow:simpleAttributesRow andSkipColumns:[GPKGSimpleAttributesTable requiredColumns]];
