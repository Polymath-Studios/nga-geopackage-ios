 ...
 *             interoperability concerns. (GeoPackage version 1.2)
 */
-(GPKGExtensions *) extensionCreateWithTable: (NSString *) tableName andColumn: (NSString *) columnName andAuthor: (NSString *) author andType: (SFGeometryType) geometryType __attribute__((deprecated));
 ...
 *             interoperability concerns. (GeoPackage version 1.2)
 */
-(BOOL) hasWithTable: (NSString *) tableName andColumn: (NSString *) columnName andAuthor: (NSString *) author andType: (SFGeometryType) geometryType __attribute__((deprecated));
 ...
 *             interoperability concerns. (GeoPackage version 1.2)
 */
+(NSString *) extensionNameWithAuthor: (NSString *) author andType: (SFGeometryType) geometryType __attribute__((deprecated));
