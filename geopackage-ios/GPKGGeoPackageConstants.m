...
NSInteger const GPKG_USER_VERSION = 10400;
...
NSString * const GPKG_SQLITE_APPLICATION_ID = @"SQLite";
NSString * const GPKG_EXTENSION_AUTHOR = @"gpkg";
NSString * const GPKG_GEOMETRY_EXTENSION_PREFIX = @"geom";
NSString * const GPKG_UNDEFINED_DEFINITION = @"undefined";
