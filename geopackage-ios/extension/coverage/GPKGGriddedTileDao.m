...
-(instancetype) initWithDatabase: (GPKGConnection *) database{
    ...
    if(self != nil){
        ...
        self.columnNames = @[GPKG_CDGT_COLUMN_ID, GPKG_CDGT_COLUMN_TABLE_NAME, GPKG_CDGT_COLUMN_TABLE_ID, GPKG_CDGT_COLUMN_SCALE, GPKG_CDGT_COLUMN_OFFSET, GPKG_CDGT_COLUMN_MIN, GPKG_CDGT_COLUMN_MAX, GPKG_CDGT_COLUMN_MEAN, GPKG_CDGT_COLUMN_STANDARD_DEVIATION];
