...
NSString * const GPKG_PROP_SRS_WGS_84_3D = @"geopackage.srs.wgs84_3d";
...
NSString * const GPKG_PROP_SRS_DEFINITION_12_063 = @"definition_12_063";
...
NSString * const GPKG_PROP_CONTENTS_DATA_TYPE = @"geopackage.extensions.contents.data_type";
NSString * const GPKG_PROP_FEATURE_GENERATOR = @"geopackage.feature_generator";
NSString * const GPKG_PROP_FEATURE_GENERATOR_DOWNLOAD_ATTEMPTS = @"download_attempts";
...
NSString * const GPKG_PROP_MANAGER_VALIDATION = @"geopackage.manager.validation";
NSString * const GPKG_PROP_MANAGER_VALIDATION_IMPORT_HEADER = @"import_header";
NSString * const GPKG_PROP_MANAGER_VALIDATION_IMPORT_INTEGRITY = @"import_integrity";
NSString * const GPKG_PROP_MANAGER_VALIDATION_OPEN_HEADER = @"open_header";
NSString * const GPKG_PROP_MANAGER_VALIDATION_OPEN_INTEGRITY = @"open_integrity";
